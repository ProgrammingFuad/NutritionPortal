...
@Injectable()
export class PatientDataAerobicService {
  //making this patient list available to other classes
  patientAerobicData: AngularFireList<any>;
  ...
  getData(){
    this.patientAerobicData = this.firebase.list('users/FW1Qik9nE3ZLiC7Xk9fgBcabUwm1/Aerobic');
    return this.patientAerobicData;
  }
