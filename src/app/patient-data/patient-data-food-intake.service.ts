...
@Injectable()
export class PatientDataFoodService {
  //making this patient list available to other classes
  patientFoodData: AngularFireList<any>;
  ...
  getData(){
    this.patientFoodData= this.firebase.list('users/FW1Qik9nE3ZLiC7Xk9fgBcabUwm1/foodIntake');
    return this.patientFoodData;  
  }
